...
<!--                 <img src="../images/bwlogo1.png"/>-->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/uploadFileLanding"><i class="fa fa-cloud-upload fa-fw"></i> Upload File</a>
                        </li>
                        <li>
                            <a href="/uploadFolderLanding"><i class="fa fa-cloud-upload fa-fw"></i> Upload Folder</a>
                         </li>
                        <li>
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
            <div class="row">
<form class="form-horizontal" method="POST" action="/uploadFolder" enctype="multipart/form-data" style="margin-left: 15px;">
<fieldset>
...
<!-- File Button -->
<div class="form-group">
  <label class="col-md-4 control-label" for="filebutton">Upload Resume Folder</label>
  <div class="col-md-4">
    <input id="file" name="file" class="input-file" type="file" multiple webkitdirectory directory>
  </div>
</div>
